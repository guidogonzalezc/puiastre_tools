...
class SpineModule():
    ...
    def spine_module(self):
        ...
        cmds.setAttr(f"{self.ik_sc}.dForwardAxis", 2)
        cmds.setAttr(f"{self.ik_sc}.dWorldUpAxis", 6)
        cmds.setAttr(f"{self.ik_sc}.dWorldUpVectorX", 1)
        cmds.setAttr(f"{self.ik_sc}.dWorldUpVectorY", 0)
        cmds.setAttr(f"{self.ik_sc}.dWorldUpVectorZ", 0)
        cmds.setAttr(f"{self.ik_sc}.dWorldUpVectorEndX", 1)
        cmds.setAttr(f"{self.ik_sc}.dWorldUpVectorEndY", 0)
