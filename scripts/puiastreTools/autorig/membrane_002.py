    ...
    def create_nurbs(self, joint01, joint02, index):
        ...
        for i in range(0, 2):
            for j in range(3):
                ...
                # Set parameterU: 0.25 when i == 0, 0.75 when i == 1
                param_u = 0.25 if i == 0 else 0.75
                cmds.setAttr(f"{pointOnSurface}.parameterU", param_u)
                ...
                cmds.setAttr(f"{pointOnSurface_offfset}.parameterU", param_u)
